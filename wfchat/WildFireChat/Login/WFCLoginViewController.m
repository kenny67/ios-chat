...
- (void)viewDidLoad {
    ...
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:@"登录即代表你已同意《用户协议》和《隐私政策》" attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:10],
